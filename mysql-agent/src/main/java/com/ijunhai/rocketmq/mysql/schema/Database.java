...
import com.ijunhai.rocketmq.mysql.schema.column.ColumnParser;
...
public class Database {
    ...
    public Database(String name, DataSource dataSource, List<String> whiteTaleList) {
        this.name = name;
    ...
    public void init() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (!whiteTaleList.contains(tableName)) {
                    continue;
                }
