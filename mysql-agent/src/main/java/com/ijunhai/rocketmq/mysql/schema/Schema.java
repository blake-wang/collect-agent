...
package com.ijunhai.rocketmq.mysql.schema;
...
public class Schema {
    ...
    public Schema(DataSource dataSource, String dbName, List<String> whiteTaleList) {
        this.dataSource = dataSource;
        this.dbName = dbName;
        this.whiteTaleList = whiteTaleList;
    }
    ...
    public void load() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (!IGNORED_DATABASES.contains(dbName) && db.equals(dbName)) {
                    Database database = new Database(dbName, dataSource, whiteTaleList);
